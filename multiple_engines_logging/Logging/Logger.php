...
class Logger {
    ...
    public static function getEngine() {
        $name = static::getLoggerName();
        return Registry::get(
            $name . '.engine',
            function() use ($name) {
                $class = Config::getClass(
                    $name . '.engine_class',
                    static::getDefaultEngineClass()
                );
    ...
    public static function setEngine($engine) {
        Registry::set(static::getLoggerName() . '.engine', $engine);
    }
     ...
     * @return string
     */
    protected static function getDefaultEngineClass() {
        return LoggerEngine::class;
    }
}
